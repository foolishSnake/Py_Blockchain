...
class AccountManager:
    ...
    def __init__(self, account_file):
        self.account_file = self.account_file
    ...
    def get_account(self, acc_num):
        if os.path.isfile(self.account_file):
            ...
            return "Can't find Accounts file \"{}\"".format(self.chain_file)
    ...
    def write_account(self, account):
        if not os.path.isfile(self.account_file):
            ...
            with open(self.account_file, "a") as bc:
                csv_write = csv.writer(bc, delimiter="|")
                csv_write.writerow(self.account.account_dict())
